...
- Read [Design Rules](/guides/design-rules/) before you spread the tuple style
  across a large codebase.
- Read [Do and Don't](/guides/do-and-dont/) if you are moving a team onto the
  library and want the conventions to stay sharp.
- Use the [reference section](/reference/error/) when you already know what
  module you need.
