...
description: Small Yieldless recipes for one feature at a time.
---
...
- [Beginner Tutorial](/docs/guides/beginner-tutorial) builds a complete file-to-API workflow step by step.
- [Read IDs and Fetch Records](/docs/recipes/read-ids-fetch-records) is a focused recipe for `readFileSafe()`, `forEach()`, and `fetchJsonSafe()`.
- [Examples](/docs/guides/examples) has larger compositions once these single-feature recipes feel comfortable.
