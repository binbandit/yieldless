...
description: Learn Yieldless by building one small file-to-API workflow from the first tuple to a complete function.
---
...
## Step 1: read a file without throwing
...
- [Simple Recipes](/docs/recipes/simple-recipes) for small copy-pasteable patterns.
- [Read IDs and Fetch Records](/docs/recipes/read-ids-fetch-records) for the same workflow as a recipe.
- [Module Selection](/docs/guides/module-selection) when you know the problem but not the helper.
- [yieldless/iterable](/docs/reference/iterable) and [yieldless/fetch](/docs/reference/fetch) for API details.
